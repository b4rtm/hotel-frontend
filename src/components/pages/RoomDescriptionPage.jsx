      ...
      <div className="room-desc">
        ...
        <div className="second-row">
          ...
          <p className="capacity">
            ...
            {room?.capacity === 1 ? t("person") : t("people")}
          </p>
          ...
          {overlapError && (
            <p style={{ color: "red" }}>{t("dateOverlapError")}</p>
          )}
          {isReservationAttempted && !startDate && !endDate && (
            <p className="error">{t("selectBothDates")}</p>
          )}
      ...
      {isModalOpen && (
        <div className="modal">
          <div className="modal-content">
            ...
            <button
              onClick={closeModal}
              style={{ backgroundColor: "darkred", border: "red" }}
            >
              {t("cancel")}
            </button>
            <button
              onClick={async () => {
                ...
                startDateWithAddedDay.setDate(
                  startDateWithAddedDay.getDate() + 1
                );
                ...
                const formattedEndDate = endDateWithAddedDay
                  .toISOString()
                  .split("T")[0];
