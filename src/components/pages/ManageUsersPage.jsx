...
const ManageUsersPage = () => {
    ...
    return (
        <div className='manage-users-page'>
                    ...
                    <tbody>
                        {users.map(user => (
                            <tr key={user.id} className='user-info'>
                                ...
                                <td>
                                    <svg onClick={() => {setCurrentUser(user); console.log(user); formik.setValues({ // Ustawia wartości formularza na podstawie aktualnego użytkownika
            id: user.id,
            name: user.name,
            ...
            password: user.password,
        });}} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="2em" height="2em" viewBox="0 0 50 50" fill="black"><title>Edytuj</title>
                                ...
                                <td>
                                    <svg onClick={() => handleDeleteUser(user.id)} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="2em" height="2em" viewBox="0 0 24 24" fill="black"><title>Usuń</title>
