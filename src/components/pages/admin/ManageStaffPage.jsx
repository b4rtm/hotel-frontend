  ...
  return (
    <div className="manage-page">
            ...
            <tbody>
              {employees.map((employee) => (
                <tr key={employee.id} className="info">
                  ...
                  <td>
                    <p>{translateRole(employee.position)}</p>{" "}
                  </td>
                  <td>
                    <svg
                      onClick={() => {
                  ...
                  <td>
                    <svg
                      onClick={() => handleOpenConfirmation(employee.id)}
                      xmlns="http://www.w3.org/2000/svg"
                      x="0px"
                      y="0px"
                      width="2em"
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="form-field">
                ...
                >
                  ...
                  <option
                    value="RECEPTIONIST"
                    label="Recepcjonista/Recepcjoniska"
                  />
      ...
      <Modal
        ...
        contentLabel="Potwierdź usunięcie pracownika"
      >
        <p>Czy na pewno chcesz usunąć pracownika?</p>
        <button
          className="delete"
          onClick={() => handleConfirmDeleteEmployee(selectedEmployeeId)}
        >
          Tak
        </button>
