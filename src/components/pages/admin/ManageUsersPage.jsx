                        ...
                        <tbody>
                            {users.map(user => (
                                <tr key={user.id} className='info'>
                                    ...
                                    <td>
                                        <svg onClick={() => handleEditUser(user)} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="2em" height="2em" viewBox="0 0 50 50" fill="black">
                                            <title>Edytuj</title>
                                    ...
                                    <td>
                                        <svg onClick={() => handleOpenConfirmation(user.id)} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="2em" height="2em" viewBox="0 0 24 24" fill="black">
                                            <title>Usuń</title>
